...
!(function () {
  ...
  class f extends e {
    constructor(e, t, n) {
      super(), __publicField(this, "value"), __publicField(this, "type"), __publicField(this, "unit"), (this.value = e), (this.type = t), (this.unit = n);
    }
  }
  class h extends e {}
  class p extends e {}
  ...
  function W(e) {
    let t = (function (e) {
      let t = "integer",
        n = "";
      for ([43, 45].includes(e.peek()[0]) && (n += String.fromCodePoint(e.consume())); P(...e.peek()); ) n += String.fromCodePoint(e.consume());
      if (46 === e.peek()[0] && P(e.peek()[1])) for (n += String.fromCodePoint(e.consume(), e.consume()), t = "number"; P(...e.peek()); ) n += String.fromCodePoint(e.consume());
      return [69, 101].includes(e.peek()[0]) && ([45, 43].includes(e.peek()[1]) && P(e.peek()[2]) ? ((n += String.fromCodePoint(e.consume(), e.consume(), e.consume())), (t = "number")) : P(e.peek()[1]) && ((n += String.fromCodePoint(e.consume(), e.consume())), (t = "number"))), { value: parseFloat(n), type: t };
    })(e);
    return _(...e.peek()) ? new f(t.value, t.type, j(e)) : 37 === e.peek()[0] ? (e.consume(), new m(t.value)) : new u(t.value, t.type);
  }
  function F(e) {
    for (;;) {
      const t = e.consume();
  ...
  function Q(e, t = {}) {
    ...
    if (e instanceof CSSUnitValue) {
      ...
      const n = e.toSum();
      if ((n && 1 === n.values.length && (e = n.values[0]), e instanceof CSSUnitValue && "em" === e.unit && t.fontSize && (e = new CSSUnitValue(e.value * t.fontSize.value, t.fontSize.unit)), e instanceof CSSKeywordValue)) {
    ...
    if (e instanceof CSSMathNegate) return e.value instanceof CSSUnitValue ? new CSSUnitValue(0 - e.value.value, e.value.unit) : e.value instanceof CSSMathNegate ? e.value.value : e;
    ...
    if (e instanceof CSSMathProduct) {
      ...
      if (2 === t.length) {
        let e, n;
        for (const i of t) i instanceof CSSUnitValue && "number" === i.unit ? (e = i) : i instanceof CSSMathSum && [...i.values].every((e) => e instanceof CSSUnitValue) && (n = i);
        if (e && n) return new CSSMathSum(...[...n.values].map((t) => new CSSUnitValue(t.value * e.value, t.unit)));
      }
      if (t.every((e) => (e instanceof CSSUnitValue && $(e.unit)) || (e instanceof CSSMathInvert && e.value instanceof CSSUnitValue && $(e.value.unit)))) {
  ...
  const X = null,
    ...
    J = {
      fontRelativeLengths: { units: new Set(["em", "rem", "ex", "rex", "cap", "rcap", "ch", "rch", "ic", "ric", "lh", "rlh"]) },
      viewportRelativeLengths: { units: new Set(["vw", "lvw", "svw", "dvw", "vh", "lvh", "svh", "dvh", "vi", "lvi", "svi", "dvi", "vb", "lvb", "svb", "dvb", "vmin", "lvmin", "svmin", "dvmin", "vmax", "lvmax", "svmax", "dvmax"]) },
      absoluteLengths: { units: new Set(["cm", "mm", "Q", "in", "pt", "pc", "px"]), compatible: !0, canonicalUnit: "px", ratios: { cm: 96 / 2.54, mm: 96 / 2.54 / 10, Q: 96 / 2.54 / 40, in: 96, pc: 16, pt: 96 / 72, px: 1 } },
      angle: { units: new Set(["deg", "grad", "rad", "turn"]), compatible: !0, canonicalUnit: "deg", ratios: { deg: 1, grad: 0.9, rad: 180 / Math.PI, turn: 360 } },
      ...
      resolution: { units: new Set(["dpi", "dpcm", "dppx"]), compatible: !0, canonicalUnit: "dppx", ratios: { dpi: 1 / 96, dpcm: 2.54 / 96, dppx: 1 } },
    },
    Z = new Map();
  ...
  function ne(e) {
    return "number" === e ? {} : "percent" === e ? { percent: 1 } : J.absoluteLengths.units.has(e) || J.fontRelativeLengths.units.has(e) || J.viewportRelativeLengths.units.has(e) ? { length: 1 } : J.angle.units.has(e) ? { angle: 1 } : J.time.units.has(e) ? { time: 1 } : J.frequency.units.has(e) ? { frequency: 1 } : J.resolution.units.has(e) ? { resolution: 1 } : "fr" === e ? { flex: 1 } : X;
  }
  function ie(e) {
    if (e instanceof CSSUnitValue) {
      let { unit: t, value: n } = e;
      const i = ee(e.unit);
      return i && t !== i.canonicalUnit && ((n *= i.ratios[t]), (t = i.canonicalUnit)), "number" === t ? [[n, {}]] : [[n, { [t]: 1 }]];
    }
  ...
  function fe(e, t, n) {
    ...
    return "-" === e.value ? (o[0] = { type: "NEGATE", value: o[0] }) : "/" === e.value && (o[0] = { type: "INVERT", value: o[0] }), { type: i, values: [...r, ...o] };
  }
  function he(e) {
  ...
  function pe(e) {
    ...
    const n = he(
      (function (e) {
        ...
        for (; e.length; ) {
          const r = e.shift();
          if (r instanceof u || r instanceof f || r instanceof m || r instanceof CSSFunction || r instanceof CSSSimpleBlock || r instanceof t) i.push(r);
  ...
  function de(e) {
    return e instanceof CSSFunction && ["calc", "min", "max", "clamp"].includes(e.name) ? pe(e) : e instanceof u && 0 === e.value && !e.unit ? new CSSUnitValue(0, "px") : e instanceof u ? new CSSUnitValue(e.value, "number") : e instanceof m ? new CSSUnitValue(e.value, "percent") : e instanceof f ? new CSSUnitValue(e.value, e.unit) : void 0;
  }
  function Se(e) {
    const t = (function (e) {
      const t = le(e);
    ...
    if ((null === t && new CSSStyleSheet().insertRule("error", 0), t instanceof u || t instanceof m || t instanceof f || t instanceof CSSFunction || new CSSStyleSheet().insertRule("error", 0), t instanceof f)) {
  ...
  !(function () {
    ...
    window.CSSUnitValue ||
      ["number", "percent", "em", "ex", "px", "cm", "mm", "in", "pt", "pc", "Q", "vw", "vh", "vmin", "vmax", "rems", "ch", "deg", "rad", "grad", "turn", "ms", "s", "Hz", "kHz", "dppx", "dpi", "dpcm", "fr"].forEach((e) => {
        if (!Reflect.defineProperty(CSS, e, { value: (t) => new CSSUnitValue(t, e) })) throw Error(`Error installing CSS.${e}`);
      });
    for (let [i, r] of Object.entries(n)) if (!(i in window) && !Reflect.defineProperty(window, i, { value: r })) throw Error(`Error installing CSSOM support for ${i}`);
  })();
  const ge = "block";
  let ve = new WeakMap(),
    Te = new WeakMap();
  ...
  function Me(e) {
    ...
    return { scrollLeft: e.scrollLeft, scrollTop: e.scrollTop, scrollWidth: e.scrollWidth, scrollHeight: e.scrollHeight, clientWidth: e.clientWidth, clientHeight: e.clientHeight, writingMode: t.writingMode, direction: t.direction, scrollPaddingTop: t.scrollPaddingTop, scrollPaddingBottom: t.scrollPaddingBottom, scrollPaddingLeft: t.scrollPaddingLeft, scrollPaddingRight: t.scrollPaddingRight };
  }
  function Pe(e, t) {
    if (!e || !t) return;
    let n = 0,
  ...
  class ScrollTimeline {
    constructor(e) {
      ve.set(this, { source: null, axis: ge, anonymousSource: e ? e.anonymousSource : null, anonymousTarget: e ? e.anonymousTarget : null, subject: null, inset: null, animations: [], subjectMeasurements: null });
      if ((Re(this, e && void 0 !== e.source ? e.source : document.scrollingElement), e && void 0 !== e.axis && e.axis != ge)) {
    ...
    get currentTime() {
      ...
      const i = this.axis,
        ...
        o = (function (e, t) {
          ...
          return "block" === t ? (t = i ? "y" : "x") : "inline" === t && (t = i ? "x" : "y"), "y" === t ? n.scrollHeight - n.clientHeight : "x" === t ? n.scrollWidth - n.clientWidth : void 0;
        })(t, i);
  ...
  function De(e, t, n, i, r) {
    ...
    const c = (function (e, t) {
        ...
        if (!e) return n;
        const [i, r] = [e.start, e.end].map((e, n) => ("auto" === e ? ("auto" === t.scrollPadding[n] ? 0 : parseFloat(t.scrollPadding[n])) : Ce(e, { percentageReference: CSS.px(t.containerSize), fontSize: CSS.px(parseFloat(t.fontSize)) })));
  ...
  function He(e, t, n, i) {
    ...
    return (Ce(t, { percentageReference: CSS.px(e.end - e.start), fontSize: CSS.px(parseFloat(r.fontSize)) }) + e.start - n.start) / (n.end - n.start);
  }
  ...
  function Xe(e) {
    (e.readyPromise = new Qe()),
      requestAnimationFrame(() => {
        var t;
        null !== ((null == (t = e.timeline) ? void 0 : t.currentTime) ?? null) && (dt(e), "play" !== e.pendingTask || (null === e.startTime && null === e.holdTime) ? "pause" === e.pendingTask && tt(e) : et(e));
      });
  }
  function Ye() {
  ...
  function et(e) {
    ...
    if (null != e.holdTime) rt(e), 0 == e.animation.playbackRate ? (e.startTime = t) : ((e.startTime = t - e.holdTime / e.animation.playbackRate), (e.holdTime = null));
    ...
    e.readyPromise && "pending" == e.readyPromise.state && e.readyPromise.resolve(e.proxy), st(e, !1, !1), lt(e), (e.pendingTask = null);
  }
  function tt(e) {
    const t = Ze(e, e.timeline.currentTime);
    null != e.startTime && null == e.holdTime && (e.holdTime = (t - e.startTime) * e.animation.playbackRate), rt(e), (e.startTime = null), e.readyPromise.resolve(e.proxy), st(e, !1, !1), lt(e), (e.pendingTask = null);
  }
  function nt(e) {
    ...
    const t = new CustomEvent("finish", { detail: { currentTime: e.proxy.currentTime, timelineTime: e.proxy.timeline.currentTime } });
  ...
  function st(e, t, n) {
    ...
    "finished" == e.proxy.playState
      ...
      : (e.finishedPromise && "resolved" == e.finishedPromise.state && (e.finishedPromise = new Qe()), "paused" != e.animation.playState && e.animation.pause());
  }
  function at(e) {
    const t = (function (e) {
  ...
  function ut(e, t) {
    ...
    0 == it(e) && null == r && (e.holdTime = 0), null == r && (e.autoAlignStartTime = !0), ("finished" === e.proxy.playState || n) && ((e.holdTime = null), (e.startTime = null), (e.autoAlignStartTime = !0)), e.holdTime && (e.startTime = null), e.pendingTask && ((e.pendingTask = null), (i = !0)), (null !== e.holdTime || e.autoAlignStartTime || n || null !== e.pendingPlaybackRate) && (e.readyPromise && !i && (e.readyPromise = null), lt(e), e.readyPromise || Xe(e), (e.pendingTask = "play"), Ae(e.timeline, e.animation, mt.bind(e.proxy)), st(e, !1, !1));
  }
  function mt(e) {
    const t = ht.get(this);
    if (!t) return;
    ...
    dt(t),
      t.pendingTask &&
        requestAnimationFrame(() => {
          "play" !== t.pendingTask || (null === t.startTime && null === t.holdTime) ? "pause" === t.pendingTask && tt(t) : et(t);
        });
  ...
  function gt(e) {
    return e instanceof ViewTimeline ? { rangeName: "cover", offset: CSS.percent(0) } : e instanceof ScrollTimeline ? CSS.percent(0) : void St();
  }
  function vt(e) {
    return e instanceof ViewTimeline ? { rangeName: "cover", offset: CSS.percent(100) } : e instanceof ScrollTimeline ? CSS.percent(100) : void St();
  }
  function Tt(e, t) {
    ...
    if (e instanceof ViewTimeline) {
      ...
      return i.length && ((n.start.rangeName = i[0]), (n.end.rangeName = i.length > 1 ? i[1] : i[0])), r.length > 1 && ((n.start.offset = r[0]), (n.end.offset = r[1])), n;
    }
    if (e instanceof ScrollTimeline) {
      const e = t.split(" ");
  ...
  function yt(e, t, n) {
    ...
    if (e instanceof ViewTimeline) {
      ...
      if (t instanceof Object) void 0 !== t.rangeName && (e = t.rangeName), void 0 !== t.offset && (i = t.offset);
        ...
        const n = B(t);
        1 === n.length ? (ye.includes(n[0]) ? (e = n[0]) : (i = Q(CSSNumericValue.parse(n[0]), {}))) : 2 === n.length && ((e = n[0]), (i = Q(CSSNumericValue.parse(n[1]), {})));
      }
  ...
  class wt {
    constructor(e, t, n = {}) {
      ...
      pt.set(r, this), ht.set(this, { animation: r, timeline: i ? t : void 0, playState: i ? "idle" : null, readyPromise: null, finishedPromise: null, startTime: null, holdTime: null, rangeDuration: null, previousCurrentTime: null, autoAlignStartTime: !1, pendingPlaybackRate: null, pendingTask: null, specifiedTiming: null, normalizedTiming: null, effect: null, animationRange: i ? Tt(t, n["animation-range"]) : null, proxy: this });
    }
    get effect() {
      const e = ht.get(this);
      return e.timeline
        ? (e.effect ||
            (e.effect = (function (e) {
              const t = e.animation.effect,
                ...
                i = {
                  apply: function (n) {
                    ...
                    if (e.timeline) {
                      ...
                      (i.localTime = Je(e, i.localTime)), (i.endTime = Je(e, i.endTime)), (i.activeDuration = Je(e, i.activeDuration));
                      const n = at(e),
                        r = i.iterations ? (n - i.delay - i.endDelay) / i.iterations : 0;
                      (i.duration = n ? CSS.percent((t * r) / n) : CSS.percent(0)), void 0 === e.timeline.currentTime && (i.localTime = null);
                    }
                    return i;
                  },
                },
                r = {
                  apply: function (i, r) {
                    ...
                    if (s.duration === 1 / 0) throw TypeError("Effect duration cannot be Infinity when used with Scroll Timelines");
                    return (null === s.duration || "auto" === s.duration || e.autoDurationEffect) && e.timeline && ((e.autoDurationEffect = !0), (s.delay = 0), (s.endDelay = 0), (o = s.iterations ? 1e5 : 0), (s.duration = s.iterations ? (o - s.delay - s.endDelay) / s.iterations : 0), s.duration < 0 && ((s.duration = 0), (s.endDelay = o - s.delay)), n.apply(t, [s])), (e.normalizedTiming = s), e.specifiedTiming;
                  },
                },
                o = {
                  apply: function (n, i, r) {
                    if (r && r.length) {
                      if (e.timeline && r[0]) {
                        const t = r[0],
                          n = t.duration;
                        if (n === 1 / 0) throw TypeError("Effect duration cannot be Infinity when used with Scroll Timelines");
                        if (t.iterations === 1 / 0) throw TypeError("Effect iterations cannot be Infinity when used with Scroll Timelines");
              ...
              return (s.getComputedTiming = new Proxy(t.getComputedTiming, i)), (s.getTiming = new Proxy(t.getTiming, r)), (s.updateTiming = new Proxy(t.updateTiming, o)), s;
            })(e)),
          e.effect)
        : e.animation.effect;
    }
    ...
    set timeline(e) {
      ...
      const a = n instanceof ScrollTimeline,
        ...
        c = this.pending;
      if ((a && Ne(t.timeline, t.animation), l)) return (t.timeline = e), rt(t), (t.autoAlignStartTime = !0), (t.startTime = null), (t.holdTime = null), ("running" !== i && "finished" !== i) || ((t.readyPromise && "resolved" !== t.readyPromise.state) || Xe(t), (t.pendingTask = "play"), Ae(t.timeline, t.animation, mt.bind(this))), "paused" === i && null !== o && (t.holdTime = o * s), c && ((t.readyPromise && "resolved" != t.readyPromise.state) || Xe(t), (t.pendingTask = "paused" == i ? "pause" : "play")), null !== t.startTime && (t.holdTime = null), void st(t, !1, !1);
    ...
    set startTime(e) {
      ...
      rt(t), (t.startTime = e), null !== t.startTime && 0 != t.animation.playbackRate ? (t.holdTime = null) : (t.holdTime = n), t.pendingTask && ((t.pendingTask = null), t.readyPromise.resolve(this)), st(t, !0, !1), lt(t);
    }
    get currentTime() {
      const e = ht.get(this);
    ...
    set currentTime(e) {
      ...
      t.timeline
        ? (!(function (e, t) {
            ...
            (t = Ze(e, t)), (e.autoAlignStartTime = !1), null !== e.holdTime || null === e.startTime || "inactive" === e.timeline.phase || 0 === e.animation.playbackRate ? (e.holdTime = t) : (e.startTime = Ze(e, e.timeline.currentTime) - t / e.animation.playbackRate), "inactive" === e.timeline.phase && (e.startTime = null), (e.previousCurrentTime = null);
          })(t, e),
          "pause" == t.pendingTask && ((t.holdTime = Ze(t, e)), rt(t), (t.startTime = null), (t.pendingTask = null), t.readyPromise.resolve(this)),
          st(t, !0, !1))
    ...
    finish() {
      ...
      if (t > 0 && n == 1 / 0) throw new DOMException("Cannot finish Animation with an infinite target effect end.", "InvalidStateError");
      rt(e);
      const i = t < 0 ? 0 : n;
      this.currentTime = Je(e, i);
      const r = Ze(e, e.timeline.currentTime);
      null === e.startTime && null !== r && (e.startTime = r - i / e.animation.playbackRate), "pause" == e.pendingTask && null !== e.startTime && ((e.holdTime = null), (e.pendingTask = null), e.readyPromise.resolve(this)), "play" == e.pendingTask && null !== e.startTime && ((e.pendingTask = null), e.readyPromise.resolve(this)), st(e, !0, !0);
    }
    play() {
      const e = ht.get(this);
    ...
    pause() {
      const e = ht.get(this);
      e.timeline ? "paused" != this.playState && (null === e.animation.currentTime && (e.autoAlignStartTime = !0), "play" == e.pendingTask ? (e.pendingTask = null) : (e.readyPromise = null), e.readyPromise || Xe(e), (e.pendingTask = "pause"), Ae(e.timeline, e.animation, mt.bind(e.proxy))) : e.animation.pause();
    }
    reverse() {
      const e = ht.get(this),
        t = it(e),
    ...
    cancel() {
      ...
      e.timeline
        ? ("idle" != this.playState &&
            (!(function (e) {
              e.pendingTask && ((e.pendingTask = null), rt(e), e.readyPromise.reject(Ye()), Xe(e), e.readyPromise.resolve(e.proxy));
            })(e),
    ...
    get finished() {
      const e = ht.get(this);
      return e.timeline ? (e.finishedPromise || (e.finishedPromise = new Qe()), e.finishedPromise.promise) : e.animation.finished;
    }
    get ready() {
      const e = ht.get(this);
      return e.timeline ? (e.readyPromise || ((e.readyPromise = new Qe()), e.readyPromise.resolve(this)), e.readyPromise.promise) : e.animation.ready;
    }
  ...
  const kt = { IDENTIFIER: /[\w\\\@_-]+/g, WHITE_SPACE: /\s*/g, NUMBER: /^[0-9]+/, TIME: /^[0-9]+(s|ms)/, SCROLL_TIMELINE: /scroll-timeline\s*:([^;}]+)/, SCROLL_TIMELINE_NAME: /scroll-timeline-name\s*:([^;}]+)/, SCROLL_TIMELINE_AXIS: /scroll-timeline-axis\s*:([^;}]+)/, VIEW_TIMELINE: /view-timeline\s*:([^;}]+)/, VIEW_TIMELINE_NAME: /view-timeline-name\s*:([^;}]+)/, VIEW_TIMELINE_AXIS: /view-timeline-axis\s*:([^;}]+)/, VIEW_TIMELINE_INSET: /view-timeline-inset\s*:([^;}]+)/, ANIMATION_TIMELINE: /animation-timeline\s*:([^;}]+)/, ANIMATION_TIME_RANGE: /animation-range\s*:([^;}]+)/, ANIMATION_NAME: /animation-name\s*:([^;}]+)/, ANIMATION: /animation\s*:([^;}]+)/, ANONYMOUS_SCROLL_TIMELINE: /scroll\(([^)]*)\)/, ANONYMOUS_VIEW_TIMELINE: /view\(([^)]*)\)/ },
    Mt = ["block", "inline", "x", "y"],
    Pt = ["nearest", "root", "self"];
  const It = new (class {
    constructor() {
      (this.cssRulesWithTimelineName = []), (this.nextAnonymousTimelineNameIndex = 0), (this.anonymousScrollTimelineOptions = new Map()), (this.anonymousViewTimelineOptions = new Map()), (this.sourceSelectorToScrollTimeline = []), (this.subjectSelectorToViewTimeline = []), (this.keyframeNamesSelectors = new Map());
    }
    ...
    replaceUrlFunctions(e, t) {
      ...
      return (e = (e = e.replace(/url\((?:(['"])(?!https?:\/\/|data:|blob:|\/)|(?!['"]?(?:https?:\/\/|data:|blob:|\/)))(?:\.\/)?/gm, `url($1${i}/`)).replace(/url\((['"])?\//gm, `url($1${n}/`));
    }
    getAnimationTimelineOptions(e, t) {
      for (let n = this.cssRulesWithTimelineName.length - 1; n >= 0; n--) {
        ...
        try {
          if (t.matches(i.selector) && (!i["animation-name"] || i["animation-name"] == e)) return { "animation-timeline": i["animation-timeline"], "animation-range": i["animation-range"] };
        } catch {}
      }
      return null;
    }
    getAnonymousScrollTimelineOptions(e, t) {
      ...
      return n ? { anonymousSource: n.source, anonymousTarget: t, source: _e(n.source ?? "nearest", t), axis: n.axis ? n.axis : "block" } : null;
    }
        ...
        (i && n) ||
          (r &&
            this.extractMatches(e.block.contents, kt.ANIMATION).forEach((t) => {
              ...
              n && i && s.push(n), i && (this.hasDuration(t) || (this.hasAutoDuration(t) && (e.block.contents = e.block.contents.replace("auto", "    ")), (e.block.contents = e.block.contents.replace(t, " 1s " + t)), (a = !0)));
            }),
    ...
    saveSourceSelectorToScrollTimeline(e) {
      ...
      if (t) {
        ...
        for (const n of t) {
          ...
          1 == t.length ? (i.name = t[0]) : 2 == t.length && (Mt.includes(t[0]) ? ((i.axis = t[0]), (i.name = t[1])) : ((i.axis = t[1]), (i.name = t[0]))), r.push(i);
        }
      }
      if (n) {
    ...
    saveSubjectSelectorToViewTimeline(e) {
      ...
      if (t) {
        ...
        for (let n of t) {
          ...
          1 == t.length ? (i.name = t[0]) : 2 == t.length && (Mt.includes(t[0]) ? ((i.axis = t[0]), (i.name = t[1])) : ((i.axis = t[1]), (i.name = t[0]))), o.push(i);
        }
      }
      if (n) {
      ...
      for (let l = 0; l < o.length; l++) s.length && (o[l].inset = s[l % o.length]), a.length && (o[l].axis = a[l % o.length]);
    ...
    saveRelationInList(e, t, n) {
      ...
      for (let o = 0; o < r; o++) this.cssRulesWithTimelineName.push({ selector: e.selector, "animation-timeline": t[o % t.length], ...(n.length ? { "animation-name": n[o % n.length] } : {}), ...(i.length ? { "animation-range": i[o % i.length] } : {}) });
    }
    ...
    saveAnonymousTimelineName(e) {
      ...
      return e.startsWith("scroll(") ? this.anonymousScrollTimelineOptions.set(t, this.parseAnonymousScrollTimeline(e)) : this.anonymousViewTimelineOptions.set(t, this.parseAnonymousViewTimeline(e)), t;
    }
    ...
    replaceKeyframesAndGetMapping(e, t) {
      ...
      const i = e.block.contents,
        r = (function (e) {
          let t = 0,
            ...
            i = -1;
          const r = [];
          for (let o = 0; o < e.length; o++) "{" == e[o] ? t++ : "}" == e[o] && t--, 1 == t && "{" != e[o] && "}" != e[o] && -1 == n && (n = o), 2 == t && "{" == e[o] && ((i = o), r.push({ start: n, end: i }), (n = i = -1));
          return r;
        })(i);
      ...
      return s ? ((e.block.contents = a.join("")), this.replacePart(e.block.startIndex, e.block.endIndex, e.block.contents, t), o) : new Map();
    }
    ...
    eatBlock(e) {
      ...
      this.assertString(e, "{");
      let n = 1;
      for (; 0 != n; ) this.lookAhead("/*", e) ? this.eatComment(e) : ("{" === e.sheetSrc[e.index] ? n++ : "}" === e.sheetSrc[e.index] && n--, this.advance(e));
      const i = e.index;
              ...
              for (const [s, a] of e)
                if (s == 100 * r.offset) {
                  if ("from" == a) o = 0;
                    ...
                    const e = a.split(" ");
                    o = 1 == e.length ? parseFloat(e[0]) : 100 * Rt(e[0], n, t.subject, i, t.inset, CSS.percent(parseFloat(e[1])));
                  }
                  break;
                }
              return o;
  ...
  function At() {
    ...
    !(function () {
      ...
      new MutationObserver((n) => {
        for (const i of n) for (const n of i.addedNodes) n instanceof HTMLStyleElement && e(n), n instanceof HTMLLinkElement && t(n);
      }).observe(document.documentElement, { childList: !0, subtree: !0 }),
        document.querySelectorAll("style").forEach((t) => e(t)),
        document.querySelectorAll("link").forEach((e) => t(e));
    })();
    const e = CSS.supports;
    (CSS.supports = (t) => ((t = t.replaceAll(/(animation-timeline|scroll-timeline(-(name|axis))?|view-timeline(-(name|axis|inset))?|timeline-scope)\s*:/g, "--supported-property:")), e(t))),
  ...
  At()
    ...
    : (function () {
        ...
        if (!Reflect.defineProperty(window, "ScrollTimeline", { value: ScrollTimeline })) throw Error("Error installing ScrollTimeline polyfill: could not attach ScrollTimeline to window");
        if (!Reflect.defineProperty(window, "ViewTimeline", { value: $e })) throw Error("Error installing ViewTimeline polyfill: could not attach ViewTimeline to window");
        if (!Reflect.defineProperty(Element.prototype, "animate", { value: bt })) throw Error("Error installing ScrollTimeline polyfill: could not attach WAAPI's animate to DOM Element");
        if (!Reflect.defineProperty(window, "Animation", { value: wt })) throw Error("Error installing Animation constructor.");
        if (!Reflect.defineProperty(Element.prototype, "getAnimations", { value: Ct })) throw Error("Error installing ScrollTimeline polyfill: could not attach WAAPI's getAnimations to DOM Element");
        if (!Reflect.defineProperty(document, "getAnimations", { value: Et })) throw Error("Error installing ScrollTimeline polyfill: could not attach WAAPI's getAnimations to document");
      })();
})();
